...
function MainPage() {
  return (
    <div>
    <h2>Online Canadian Citizenship Test 2024🍁</h2>
    <p>Ready for your citizenship test? Study for the Canadian citizenship test in 2024 with the official study guide and actual test questions. 
