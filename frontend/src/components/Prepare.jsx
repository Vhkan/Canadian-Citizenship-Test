...
const Prepare = () => {
  return (
    <div>
      ...
      <p>The assessment comprises 20 questions spanning diverse categories. In the event of an incorrect response, there are up to 4 alternatives. Additionally, there may be up to 3 questions that have been skipped, which will be presented upon completion of the remaining questions in the test. </p> 
    </div>
  )
}
